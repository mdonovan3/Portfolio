...
const Repositories = () => {
  const repos = [
    {
      title: "Aloha POS Polling Client",
      description: "Imports wine sales from Aloha DBF files to AWS database.",
      url: "https://github.com/mdonovan3/ImportWineSales",
      tags: ["R", "PostgreSQL", "inventory", "restaurant analytics", "RDS"],
    },
    {
